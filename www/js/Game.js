class Game {
    ...
    checkDiagRight(row, col) {
        ...
        for (let down = row + 1, right = col + 1; down < 6 && right < 7 && board[down][right] === currPlayer && winCounter <= 3; down++, right++) {
            winCounter++;
        }
    ...
    checkDiagLeft(row, col) {
        ...
        for (let down = row + 1, left = col - 1; down < 6 && left > 0 && board[down][left] === currPlayer && winCounter <= 3; left--, down++) {
            winCounter++;
        }
